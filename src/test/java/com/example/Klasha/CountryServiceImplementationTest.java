...
import com.example.Klasha.services.serviceImplementation.CountryServiceImplementation;
...
public class CountryServiceImplementationTest {
    @Mock
    private RestTemplate restTemplate;

    @InjectMocks
    private CountryServiceImplementation countryEntityService;
    ...
    public void testGetCountryEntity() {
        ...
        CountryResponse result = countryEntityService.getCountryEntity("Nigeria");
